...
public class BookArray2 {
	...
	public static void main(String[] args) {
		// 추가사항 book 클래스에 매개변수가 3개인 생성자 만들기
		// 매개변수 요소 책이름, 작가, 가격
		// library2 참조형 변수 배열 만들기, 크기 3
		...
		library2[0] = new Book("태백산맥", "조정래", 15000);
		library2[1] = new Book("데미안", "헤르만 헤세", 16000);
		library2[2] = new Book("어떻게 살 것인가", "유시민", 17000);
